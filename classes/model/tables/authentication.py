...
class Authentication(InfoMixin, OwnerMixin):
    ...
    type          = Column(String, nullable=False, unique=True, info={'Validators':[EnglishSpecial]})
    username      = Column(String, nullable=False, info={'Validators':[EnglishSpecial, Username]})
